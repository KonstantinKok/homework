...
async def news(age: int = Path(min_length=18, max_length=120), username: str = Path(min_length=5, max_length=20, description="Enter you username", example="montes")) -> dict:
